...
wget https://download.copr.fedorainfracloud.org/results/gloriouseggroll/nobara/fedora-38-x86_64/06431294-kernel/kernel-6.5.4-200.fsync.fc38.src.rpm
rm -rf $HOME/rpmbuild/
rpm -Uvh kernel-6.5.4-200.fsync.fc38.src.rpm
...
wget https://github.com/jlobue10/ALLY_Nobara_fixes/raw/main/ROG-ALLY-NCT6775-PLATFORM.patch
