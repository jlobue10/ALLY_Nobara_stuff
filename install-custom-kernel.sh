...
cp $CURRENT_WD/{.config,Makefile} $HOME/rpmbuild/BUILD/kernel-6.5.3/linux-6.5.3-200.fsync.fc38.x86_64/
cp $CURRENT_WD/kernel.spec $HOME/rpmbuild/SPECS
rpmbuild -bp $HOME/rpmbuild/SPECS/kernel.spec
cd $HOME/rpmbuild/BUILD/kernel-6.5.3/linux-6.5.3-200.fsync.fc38.x86_64/
